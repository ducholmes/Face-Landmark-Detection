...
from data.components.wflw_regression_dataset import WFLWRegressionDataset

class WFLWRegressionDataModule(LightningDataModule):
    def __init__(
        self,
        data_dir: str = '/data',
    ...
    def setup(self, stage=None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            if stage=='fit' or stage == None:
                train_base = WFLWRegressionDataset(
                ...
                val_base = WFLWRegressionDataset(
                    img_dir=self.img_dir,
            ...
            if stage=='test':
                test_base = WFLWRegressionDataset(
                    img_dir=self.img_dir,
                    landmark_path=self.test_keypoint_path,
                    transform=self.test_transform
                )
